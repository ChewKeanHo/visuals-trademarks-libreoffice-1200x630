# LibreOffice Trademarks Logo 1200x630 | (Holloway) Chew, Kean Ho's Visuals

[![logo](/Pictures/banner_1200x630.svg)](#)

The LibreOffice Trademarks Logo. They published great trademark guideline and
supplied the required material files to work on. The preferred version is `.svg`
...
This project re-draws LibreOffice Trademarks Logo specifically for 1200x630
size.
...
LibreOffice published a number of its brand and trademark guidelines. **Please
refer to the following from time to time to avoid any unwanted legal
implications**:

* https://wiki.documentfoundation.org/Design/Branding
* https://wiki.documentfoundation.org/Gallery_Logos

While not specified by LibreOffice, please ensure the outputs are also web
ready. Refer:
...
```
--------------------------------------------------------------------------------
Title: LibreOffice Trademarks Logo 1200x630
Creators: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-trademarks-libreoffice-1200x630
UUID: 13265E0F-95DC-4C01-B0CF-B5DC996B5B43
License: Creative Commons Attribution-NoDerivatives 4.0 International License
Made On: 2026-02-16
Made From: Malaysia, South East Asia
Procure: https://github.com/chewkeanho/visuals-trademarks-libreoffice-1200x630
--------------------------------------------------------------------------------
```
...
> COMPLY WITH LIBREOFFICE TRADEMARK REQUIREMENTS
> (refer: https://wiki.documentfoundation.org/Design/Branding)**.
>
